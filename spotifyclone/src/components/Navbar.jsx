...
const Navbar = () => {
  return (
    <>
    <div className='w-full flex justify-between itens-center font-semibold'>
        ...
        <div className='flex items-center gap-4'>
            ...
            <p className='bg-black py-1 px-3 rounnded-2xl text-[15px] cursor-pointer'>Install App</p>
